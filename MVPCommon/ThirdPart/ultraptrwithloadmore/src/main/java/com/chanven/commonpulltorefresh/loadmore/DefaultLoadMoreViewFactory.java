...
//		protected LinearLayout footer_root;
		...
		protected ProgressWheel footerBar;
...
//			mFooterView = view;
			...
			footerBar = (ProgressWheel) view.findViewById(R.id.loadmore_default_footer_progressbar);
//			footer_root = (LinearLayout) view.findViewById(R.id.footer_root);
