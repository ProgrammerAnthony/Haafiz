package com.anthony.app.common.widgets.subscribeview;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<Channel> mMyChannelItems, mOtherChannelItems;

    public List<Channel> getMyChannelItems() {
        return mMyChannelItems;
    }

    public void setMyChannelItems(List<Channel> mMyChannelItems) {
    ...
    public void setOtherChannelItems(List<Channel> mOtherChannelItems) {
    ...
    public ChannelAdapter(Context context, ItemTouchHelper helper, List<Channel> mMyChannelItems,
                          List<Channel> mOtherChannelItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.prj_item_my_channel_header, parent, false);
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.prj_item_my, parent, false);
            ...
            case TYPE_OTHER_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.prj_item_other_channel_header, parent, false);
                return new RecyclerView.ViewHolder(view) {
                };

            case TYPE_OTHER:
                view = mInflater.inflate(R.layout.prj_item_other, parent, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener {
        ...
        public void onItemSelected() {
            textView.setBackgroundResource(R.drawable.prj_btn_gray_bg_press);
        }
        ...
        public void onItemFinish() {
            textView.setBackgroundResource(R.drawable.prj_btn_gray_bg_selector);
        }
    }
