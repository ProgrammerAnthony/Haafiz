package edu.com.app.module.find.nearby.list;
...
import edu.com.app.module.find.nearby.radarScan.CustomViewPager;
import edu.com.app.module.find.nearby.radarScan.FixedSpeedScroller;
import edu.com.app.module.find.nearby.radarScan.Info;
import edu.com.app.module.find.nearby.radarScan.RadarViewGroup;
import edu.com.app.module.find.nearby.radarScan.ZoomOutPageTransformer;
 ...
 * Class Note:
 */
public class NearByListFragment extends AbsTitleFragment  implements ViewPager.OnPageChangeListener, RadarViewGroup.IRadarClickListener{
    @Bind(R.id.radar)
...
//            MainActivity.openDrawer();
    ...
    protected int getCenterViewID() {
        return R.layout.fragment_nearby_scan;
    }
...
//        toggleShowLoading(false,"");
    ...
    private void setViewPagerSpeed(int duration) {
        try {
            ...
            scroller = new FixedSpeedScroller(mContext, new AccelerateInterpolator());
